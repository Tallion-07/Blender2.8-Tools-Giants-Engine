...
import time
from . import dcc
from addons.io_export_i3d import i3d_export, i3d_import # NOTE needs to be changed before testing and release
...
def menu_func_import(self, context):
    self.layout.operator(I3D_Import.bl_idname, text="I3D (.i3d)")
    
def menu_func_export(self, context):
    self.layout.operator(I3D_Export.bl_idname, text="I3D (.i3d)")    
...
def register():
    ...
    bpy.types.Operator(I3D_FileExport) 
    bpy.types.INFO_MT_file_export.append(fileExportMenuItem)
    bpy.types.Operator(I3D_PanelExport_ButtonExport)
    bpy.types.Operator(I3D_PanelExport_ButtonAttr)
