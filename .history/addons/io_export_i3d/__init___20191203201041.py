...
import time
import sys
sys.path.insert(0, '/Users/Jason Oppermann/Github-source/repos/Tallion-07/I3d-Import-Export-Tools-for-Blender-2.8/addons')


from addons.io_export_i3d import i3d_export, i3d_import, dcc # NOTE needs to be changed before testing and release
# from . import dcc
...
if "bpy" in locals():
    import importlib
if "i3d_import" in locals():
    importlib.reload(i3d_import) 
if "i3d_export" in locals():
...
from addons import io_export_i3d

class I3D_Import(bpy.types.Operator, ImportHelper):
    """Import a i3d file."""
# ----------------------------------------------
...
class I3D_Export(bpy.types.Operator, ExportHelper):  # changed bpy_extras.io_utils.ExportHelper
    """Write a I3D file."""
...
def menu_func_import(self, context):
    self.layout.operator(I3D_Import.bl_idname, text="GIANTS I3D (.i3d)")
    
def menu_func_export(self, context):
    self.layout.operator(I3D_Export.bl_idname, text="GIANTS I3D (.i3d)")    
