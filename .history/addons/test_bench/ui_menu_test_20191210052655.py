...
class I3D_Menu(bpy.types.Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("wm.save_as_i3d_mainfile")  # NOTE not showing in menu
...
def register():
    # i3d_ui.register()  <- NOTE is this required to active module
...
def unregister():
    # i3d_ui.unregister() <- NOTE to deregister module
