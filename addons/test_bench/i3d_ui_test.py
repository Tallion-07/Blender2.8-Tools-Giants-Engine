...
import bpy_extras.io_utils import ExportHelper
...
class I3D_FileExport(Operator, ExportHelper):  # changed bpy_extras.io_utils.ExportHelper
    ...
    filter_glob: StringProperty(
        default="*.i3d",
        options={'HIDDEN'},
        maxlen=255,  # NOTE Max internal buffer length, longer would be clamped
        )
